...
public class MainActivity extends Activity implements OnClickListener
{
	...
	protected void onStart()
	{
		...
		Trace.Verbose(LOG_TAG, "Setting up Next Button Event Handler");
		...
		{
			Trace.Error(LOG_TAG, "Failed to find Next Button");
		}
	}
	...
	public void onClick(View v)
	{
		...
		{
			case R.id.btnNext:
				Trace.Verbose(LOG_TAG, "Next Button Clicked - Transitioning to SecondActivity");
